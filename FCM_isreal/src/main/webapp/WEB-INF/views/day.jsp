...
<title>수빈 통계 페이지</title>
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/day.css">
<link rel="stylesheet"
	href="//code.jquery.com/ui/1.8.18/themes/base/jquery-ui.css" />
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script src="//code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
<script type="text/javascript" src="subin.js"></script>
<script>
	$(function() {
...
<body>
	...
	<form name="d" action="search" method="POST">
		<input type="text" name="startDate" id="startDate" /> ~ <input
			type="text" name="endDate" id="endDate" /> <input type="button"
			value="조회" onclick="nodate()">
	</form>
	...
	<table id="a_table" class='scrolltbody'>
		...
		<tbody>
			...
			try {
				...
				"select * from A_amount,B_amount,C_amount,D_amount,E_amount Where (A_amount.date Between ? and ?) AND (A_amount.date=B_amount.date and A_amount.date=C_amount.date and A_amount.date=D_amount.date and A_amount.date = E_amount.date) ORDER BY A_amount.date");
