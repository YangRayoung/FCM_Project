...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/chart.css">
...
<body>
	...
	<div id="chartContainer11" style="height: 370px; width: 18%;display: inline-block;"></div>
	<div id="chartContainer12" style="height: 370px; width: 18%;display: inline-block;"></div>
	<div id="chartContainer13" style="height: 370px; width: 18%;display: inline-block;"></div>
	<div id="chartContainer14" style="height: 370px; width: 18%;display: inline-block;"></div>
	<div id="chartContainer15" style="height: 370px; width: 18%;display: inline-block;"></div>
