...
public class heejin2 {
	   ...
	   public static int[] change_heejin = new int[5];
	   ...
	   public static void receive2(String a, String b, String c, String d, String e) //string to integer
	   { 
		   change_heejin[0] = Integer.parseInt(a);
		   change_heejin[1] = Integer.parseInt(b);
		   change_heejin[2] = Integer.parseInt(c);
		   change_heejin[3] = Integer.parseInt(d);
		   change_heejin[4] = Integer.parseInt(e);
	   }
	   public static void receive1()
	   {
	      cost_home[0] = change_heejin[0];
	      cost_home[1] = change_heejin[1];
	      cost_home[2] = change_heejin[2];
	      cost_home[3] = change_heejin[3];
	      cost_home[4] = change_heejin[4];
	   ...
	   {
	      heejin2 jhj = new heejin2();
	      
	      jhj.reset_0();
	      jhj.receive(70,70,70,30,80);
	      jhj.cal_importance();
	      jhj.on_off();
	      jhj.reset();
	      jhj.input_num();
